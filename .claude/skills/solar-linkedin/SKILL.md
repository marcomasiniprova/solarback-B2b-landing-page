...
5. **Lista del giorno (proposta):** i primi N titolari (N = volume approvato o 20 di default) → `approval_add` kind `other`, title "Lista contatti LinkedIn del <data>", payload con nomi/aziende/URL.
