...
const ICONS = {
  ...
  whatsapp: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M3 21l1.5-5.5A9 9 0 1 1 8.5 20L3 21z"/><path d="M9 9.5c.2-1.2 1.4-1.8 2.4-1.5.6.2 1 .6 1.2.2.6 0 1.1-.4 1.4-.3.2-.3.5-.1.9.3.6.9 1.2 1.5 1.5 1.5.4.2.7.1.9-.1.3-.4.8-.6 1.4-.4.6.2 1.2 1.4 1 2.4-.5 2.6-2.6 3.4-4.5 1.6"/></svg>,
